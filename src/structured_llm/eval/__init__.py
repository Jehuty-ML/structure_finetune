...
def evaluate_suite(
    ...
    for case in suite.get("cases", []):
        ...
        output = _resolve_output(case, input_obj, [], system_prompt, mode, generate_fn)
        vr = validate_turn(
            output,
            schema=schema,
    ...
    return {
        ...
        "tts_safe_rate": tts_ok / total if total else 0.0,
...
def _resolve_output(
    ...
    user_message = format_user_message(input_obj, prior_utters)
